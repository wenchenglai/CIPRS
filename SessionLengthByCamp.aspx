<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SessionLengthByCamp.aspx.cs" Inherits="SessionLengthByCamp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="divReport" runat="server" visible="false">
        ...
        <div id="div3rdTimers" visible="false" runat="server">
            ...
            <asp:GridView ID="gv3rdTimers" runat="server" />
        </div>     
    </div>
</asp:Content>
