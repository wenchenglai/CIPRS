...
function ValidateQ1(sender, args) {
    ...
    for (var i = 0; i < inputobjs.length - 1; i++) {
        ...
        if (inputobjs[i].id.indexOf("chk2") >= 0 && inputobjs[i].checked) {
            ...
            if (trim(txtbox.value) == "") {
                ...
                bValid = true;
        } //A publication/flyer/poster (formerly Advertisement)
        else if (inputobjs[i].id.indexOf("chk4") >= 0 && inputobjs[i].checked) {
            txtbox = document.getElementById(inputobjs[i].id.replace("chk4", "txt4"));
            bChecked = true; //a checkbox is checked
            if (trim(txtbox.value) == "") {
                strErrorMsg = "<li>Please enter where you saw the publication/flyer/poster</li>";
                txtbox.focus();
            }
            else
                bValid = true;
        ...
        //TV: 10/05/2009 Publication (Advertisement)
        else if (inputobjs[i].id.indexOf("chk7") >= 0 && inputobjs[i].checked) {
            txtbox = document.getElementById(inputobjs[i].id.replace("chk7", "txt7"));
            bChecked = true; //a checkbox is checked
            if (trim(txtbox.value) == "") {
        ...
        //A Radio Station
        else if (inputobjs[i].id.indexOf("chk8") >= 0 && inputobjs[i].checked) {
            txtbox = document.getElementById(inputobjs[i].id.replace("chk8", "txt8"));
            bChecked = true; //a checkbox is checked
            if (trim(txtbox.value) == "") {
                strErrorMsg = "<li>Please enter a radio station</li>";
                txtbox.focus();
            }
            else
                bValid = true;
        ...
        //A TV Station
        else if (inputobjs[i].id.indexOf("chk9") >= 0 && inputobjs[i].checked) {
            txtbox = document.getElementById(inputobjs[i].id.replace("chk9", "txt9"));
            bChecked = true; //a checkbox is checked
            if (trim(txtbox.value) == "") {
                strErrorMsg = "<li>Please enter a tv station</li>";
                txtbox.focus();
            }
            else
                bValid = true;
        ...
        //A Facebook Ad
        else if (inputobjs[i].id.indexOf("chk10") >= 0 && inputobjs[i].checked) {
            bChecked = true; //a checkbox is checked
            bValid = true;
        }
        //Google
        else if (inputobjs[i].id.indexOf("chk11") >= 0 && inputobjs[i].checked) {
            bChecked = true; //a checkbox is checked
            bValid = true;
        }
        //Yahoo
        else if (inputobjs[i].id.indexOf("chk12") >= 0 && inputobjs[i].checked) {
            bChecked = true; //a checkbox is checked
            bValid = true;
        }
        //Bing
        else if (inputobjs[i].id.indexOf("chk13") >= 0 && inputobjs[i].checked) {
            bChecked = true; //a checkbox is checked
            bValid = true;
        }
        //Twitter
        else if (inputobjs[i].id.indexOf("chk14") >= 0 && inputobjs[i].checked) {
            bChecked = true; //a checkbox is checked
            bValid = true;
        }
        else if (inputobjs[i].id.indexOf("chk1") >= 0 && inputobjs[i].checked) {
            txtbox = document.getElementById(inputobjs[i].id.replace("chk1", "txt1"));
            bChecked = true; //a checkbox is checked
            if (txtbox != null)
                if (trim(txtbox.value) == "") {
        ...
        if (inputobjs[i].id.indexOf("txtReferalCode") >= 0) {
            txtreferalcode = document.getElementById(inputobjs[i].id); ;
            if (txtreferalcode.value == "") {
                bReferralCode = false;
                bValid = false;
                strErrorMsg = "<li>Please enter referral code</li>";
            }
            message = "<li>Please check any one option for Question 2</li>";
        }
    } //end of for loop
